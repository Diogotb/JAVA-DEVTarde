...
public class ConnectionDAO {
    ...
    public void criaTabela() {
        ...
        String sql = "CREATE TABLE IF NOT EXISTS tabela_turmaa (ID SERIAL PRIMARY KEY,NOME VARCHAR(255),EMAIL VARCHAR(255))";
    ...
    public void apagarTabela() {
        ...
        String sql = "DROP TABLE Tabela_turmaa";
    ...
    public void inserir(String nome, String email) {
        ...
        String sql = "INSERT INTO tabela_turmaa (NOME, EMAIL) VALUES (?, ?)";
    ...
    public void buscarPorId(int id) {
        ...
        String sql = "SELECT * FROM tabela_turmaa WHERE ID = ?";
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            stmt.setInt(1, id);
    ...
    public void apagarID(int id) {
        ...
        String sql = "DELETE FROM tabela_turmaa WHERE ID = ?";
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            stmt.setInt(1, id);
            stmt.executeUpdate(); // Executa a instrução SQL
    ...
    public void atualizarID(int id, String novoNome, String novoEmail) {
        ...
        String sql = "UPDATE tabela_turmaa SET nome = ?, email = ? WHERE ID = ?";
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
    ...
    public void listarTodos() {
        ...
        String sql = "SELECT * FROM tabela_turmaa";
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
